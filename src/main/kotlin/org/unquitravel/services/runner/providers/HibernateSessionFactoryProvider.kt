package org.unquitravel.services.runner.providers
...
class HibernateSessionFactoryProvider private constructor() {
    ...
    init {
        ...
        val dataBase = env.getOrDefault("DATA_BASE", "unquitravel")
        ...
        configuration.setProperty("hibernate.connection.url", "jdbc:mysql://$host:3306/$dataBase?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC")
